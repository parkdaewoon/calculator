...
import { loadOvertimeHoursInput, saveOvertimeHoursInput } from "@/lib/calendar/overtimeInput";
...
export default function WorkSummarySheet({ open, onClose, stats, month }: WorkSummarySheetProps) {
  ...
  return (
    <Sheet open={open} onClose={onClose} title="근무시간 상세">
      <div className="space-y-3">
        <div className="rounded-2xl border border-neutral-100 bg-neutral-50 p-4">
          <div className="flex items-start justify-between gap-4">
            <div className="min-w-0">
              <div className="text-[11px] font-semibold text-neutral-500">총 근무시간(휴일근무시간 제외)</div>
            ...
            <div className="shrink-0 text-right">
              <div className="text-[11px] font-semibold text-neutral-500">초과근무(시간)</div>
              ...
              {parsedOT == null && (
                <div className="mt-1 text-[11px] text-red-500">숫자로 입력해줘.</div>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-2xl border border-neutral-100 bg-white p-4">
            <div className="text-[11px] font-semibold text-neutral-500">야간근무(시간)</div>
          ...
          <div className="rounded-2xl border border-neutral-100 bg-white p-4">
            <div className="text-[11px] font-semibold text-neutral-500">휴일근무(일수)</div>
            <div className="mt-1 text-lg font-semibold text-neutral-900">
              {stats.holidayDays}일
            </div>
          </div>
        ...
        <button
          onClick={onClose}
          className="mt-2 w-full rounded-2xl bg-neutral-900 px-4 py-3 text-sm font-semibold text-white"
          type="button"
        >
          닫기
        </button>
